...
class TestProgram(unittest.TestCase):
    ...
    def test_case_3(self):
        yca = program.getYoungestCommonAncestor(
            ancestralTrees["A"], ancestralTrees["G"], ancestralTrees["M"]
        )
        self.assertTrue(yca == ancestralTrees["A"])

    def test_case_4(self):
        yca = program.getYoungestCommonAncestor(
            ancestralTrees["A"], ancestralTrees["U"], ancestralTrees["S"]
        )
        self.assertTrue(yca == ancestralTrees["A"])

    def test_case_5(self):
        yca = program.getYoungestCommonAncestor(
            ancestralTrees["A"], ancestralTrees["Z"], ancestralTrees["M"]
        )
        self.assertTrue(yca == ancestralTrees["A"])

    def test_case_6(self):
        yca = program.getYoungestCommonAncestor(
            ancestralTrees["A"], ancestralTrees["O"], ancestralTrees["I"]
        )
        self.assertTrue(yca == ancestralTrees["B"])

    def test_case_7(self):
        yca = program.getYoungestCommonAncestor(
            ancestralTrees["A"], ancestralTrees["T"], ancestralTrees["Z"]
        )
        self.assertTrue(yca == ancestralTrees["H"])

    def test_case_8(self):
        yca = program.getYoungestCommonAncestor(
            ancestralTrees["A"], ancestralTrees["T"], ancestralTrees["V"]
        )
        self.assertTrue(yca == ancestralTrees["H"])

    def test_case_9(self):
        yca = program.getYoungestCommonAncestor(
            ancestralTrees["A"], ancestralTrees["T"], ancestralTrees["H"]
        )
        self.assertTrue(yca == ancestralTrees["H"])

    def test_case_10(self):
        yca = program.getYoungestCommonAncestor(
            ancestralTrees["A"], ancestralTrees["W"], ancestralTrees["V"]
        )
        self.assertTrue(yca == ancestralTrees["V"])

    def test_case_11(self):
        yca = program.getYoungestCommonAncestor(
            ancestralTrees["A"], ancestralTrees["Z"], ancestralTrees["B"]
        )
        self.assertTrue(yca == ancestralTrees["B"])

    def test_case_12(self):
        yca = program.getYoungestCommonAncestor(
            ancestralTrees["A"], ancestralTrees["Q"], ancestralTrees["W"]
        )
        self.assertTrue(yca == ancestralTrees["H"])

    def test_case_13(self):
        yca = program.getYoungestCommonAncestor(
            ancestralTrees["A"], ancestralTrees["A"], ancestralTrees["Z"]
        )
        self.assertTrue(yca == ancestralTrees["A"])
